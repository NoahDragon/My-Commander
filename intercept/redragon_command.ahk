...
obsCommand(key){
	...
	;ControlSend, , ^!p, ahk_class Qt5QWindowIcon ; Occasionally works
...
prepareStreaming(){
	...
	ifWinNotExist, Auto-Duck
		Run, "C:\Users\HC\AppData\Roaming\Microsoft\Internet Explorer\Quick Launch\User Pinned\TaskBar\Auto-Duck in Real Time 2.2.2.lnk"
	else
		WinActivate, Auto-Duck
